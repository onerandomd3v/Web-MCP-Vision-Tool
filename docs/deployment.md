...
TypeScript server, runs production Prisma migrations, and starts `dist/apps/backend/server/index.js`.
...
The client output is `apps/web/dist/`. Vercel is configured to serve that directory.
